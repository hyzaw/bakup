...
class H5st527AlgoConfig implements H5stAlgoConfigType {
  genSignDefault = true;
  genSignDefaultStr = 'appId:appid&functionId:functionId';
  genSignStk = true;
  tokenVersion = LocalTokenVersion['05'];
  ...
  genLocalTK = {
    ...
    cipher: {
      prefix: 'b7',
      extend: {
        dict: '0123456789abcdefghijklmnozABCDEFGHIJKLMNOPQRSTUVWXYZ_-',
        index: 3,
        magic: '2',
      },
    },
  ...
  customAlgorithm = {
    ...
    transformMessageOptions: {
      map: 'fedcbaZYXWVUTSRQPONMLKJIHGFEDCBA-_9876543210zyxwvutsrqponmlkjihg',
      segments: 6,
      multiplier: 30,
    },
  };
...
class H5st528AlgoConfig implements H5stAlgoConfigType {
  genSignDefault = true;
  genSignDefaultStr = 'appId:appid&functionId:functionId';
  genSignStk = true;
  tokenVersion = LocalTokenVersion['05'];
  ...
  genLocalTK = {
    ...
    cipher: {
      prefix: 'd9',
      extend: {
        dict: '01234567ijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_-',
        index: 3,
        magic: '2',
      },
    },
...
class H5st529AlgoConfig implements H5stAlgoConfigType {
  genSignDefault = true;
  genSignDefaultStr = 'appid:appid&functionId:functionid';
  genSignStk = true;
  tokenVersion = LocalTokenVersion['05'];
  ...
  genLocalTK = {
    ...
    cipher: {
      prefix: 'fc',
      extend: {
        dict: '0123456789abcdefghijklmnopqrstuvwHIJKLMNOPQRSTUVWXYZ_-',
        index: 3,
        magic: '2',
      },
    },
